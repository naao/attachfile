...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return attachfile_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'attachfile_oninstall_base' ) ) {

function attachfile_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'attachfile_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function attachfile_message_append_oninstall( &$module_obj , &$log )
{
