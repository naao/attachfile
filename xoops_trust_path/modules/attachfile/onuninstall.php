...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return attachfile_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'attachfile_onuninstall_base' ) ) {

function attachfile_onuninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'attachfile_message_append_onuninstall' ) ;
		$ret = array() ;
	} else {
...
function attachfile_message_append_onuninstall( &$module_obj , &$log )
{
